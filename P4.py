...
# ---
# 
# * Estudiante: **Edin Cascante Espinoza**
# * Carné: **B71724**
# * Grupo: **2**
# 
# ---
...
def modulador(bits, fc, mpp):
    ...
    # 5. Calcular la potencia promedio de la señal modulada
    Pm = (1 / (N*Tc)) * np.trapz(pow(senal_Tx_I + senal_Tx_Q, 2), t_simulacion)
...
# Inicialización del proceso aleatorio senal_Tx con N realizaciones
N = 10
X_t = np.empty((N, len(senal_Tx)))

# Creación de las muestras del proceso 
for i in range(N):
	X_t[i,:] = senal_Tx
	plt.plot(t, senal_Tx)
